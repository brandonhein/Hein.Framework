...
{
    /// <summary>
    /// with help from marodafonseca : https://github.com/marcodafonseca
    /// </summary>
    internal class DynamoValueConverter
    {
        internal static IDictionary<Type, Func<object, AttributeValue>> ConvertToAttributeValue = new Dictionary<Type, Func<object, AttributeValue>>
        {
            ...
            { typeof(DateTime), (object @object) => new AttributeValue { S = ((DateTime)@object).ToUniversalTime().ToString(Format.DateFormat) } },
            { typeof(DateTime?), (object @object) =>
                {
                    var attributeValue = new AttributeValue();
                    if (@object != null)
                        attributeValue.S = ((DateTime)@object).ToUniversalTime().ToString(Format.DateFormat);
                    else
                        attributeValue.NULL = true;
                    return attributeValue;
                }
        ...
        internal static IDictionary<Type, Func<AttributeValue, object>> ConvertToValue = new Dictionary<Type, Func<AttributeValue, object>>
        {
            ...
            { typeof(DateTime), (AttributeValue attributeValue) => DateTime.ParseExact(attributeValue.S, Format.DateFormat, CultureInfo.InvariantCulture)},
            { typeof(DateTime?), (AttributeValue attributeValue) =>
                {
                    if (!attributeValue.NULL)
                        return DateTime.ParseExact(attributeValue.S, Format.DateFormat, CultureInfo.InvariantCulture);
                    return null;
                }
            },
