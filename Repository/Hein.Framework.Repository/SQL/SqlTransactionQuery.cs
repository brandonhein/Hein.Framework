        ...
        private string BuildCommandStart()
        {
            ...
            switch (_transactionType)
            {
                case SqlTransactionType.Insert:
                    return string.Concat(command, "INSERT INTO ", typeof(T).Name);
                case SqlTransactionType.Update:
                    return string.Concat(command, "UPDATE ", typeof(T).Name);
                case SqlTransactionType.Delete:
                    return string.Concat(command, "DELETE ", typeof(T).Name);
            }
