...
namespace Hein.Framework.Serialization.Tests
{
    public class DeserializeTests
    {
        ...
        {
            var result = Deserialize.JsonToObject<Farm>(ExpectedOutcome.FarmA_Json1);
        ...
        {
            var result = Deserialize.JsonToObject<Farm>(ExpectedOutcome.FarmA_Json2);
            var farm = TestObject.FarmA;
        ...
        {
            var result = Deserialize.XmlToObject<Farm>(ExpectedOutcome.FarmA_Xml);
            var farm = TestObject.FarmA;
        ...
        {
            var result = Deserialize.SoapToObject<Farm>(ExpectedOutcome.FarmA_Soap);
            var farm = TestObject.FarmA;
